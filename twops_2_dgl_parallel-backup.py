...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Konvertiere TwoPhase-Partitionen in dgl-kompatibles Format")
    ...
    parser.add_argument("--json_name", type=str,
                        help="Name der JSON-Ausgabedatei, zb. 'cora.json'")
    parser.add_argument("--graph_name", type=str,
                        help="Name des Graphs in der JSON-Datei, zb. 'cora'")
